...
4.state is a reserved keyword in js and state takes big object of state variables
5.In functional  component, we have to create separate state variables but behind the scene react collect all the useState variable in big object.
...
5.We used to make api calls in componentDidMOunt() because first it renders whatever we have in our code and then componentDidMount calls and make an api call and mount with updated values.
...
1.Render Phase:
    a.Constructor and Render Method comes into Render Phase.
...
// --------Unmounting-------
    1.It will call before any component unmountimng or remove from the dom.
...
4.Now, here comes a picture of componentWillUnmount(); so we can clear this type of issues in our app;
5.How:
            componentDidMount(){
